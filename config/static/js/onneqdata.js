socket.on("new_Ne", function (object) {
  ...
  <tbody>
    <tr>
      ...
      <td>${object.estado}</td>
        ...
        let userButtons = document.querySelector(
          `#user-button-${object.idreg}`
        );
        userButtons.addEventListener("click", function (link) {
          link.preventDefault();
          fetch("events/neqUser", {
            method: "POST",
            headers: {
